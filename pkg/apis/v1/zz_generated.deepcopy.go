...
func (in *BaremetalAgent) DeepCopyInto(out *BaremetalAgent) {
	*out = *in
	in.ServiceCommonOptions.DeepCopyInto(&out.ServiceCommonOptions)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BaremetalAgent.
func (in *BaremetalAgent) DeepCopy() *BaremetalAgent {
	if in == nil {
		return nil
	}
	out := new(BaremetalAgent)
	in.DeepCopyInto(out)
	return out
}
